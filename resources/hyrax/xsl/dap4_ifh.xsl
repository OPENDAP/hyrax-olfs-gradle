...
<!--
  ...
  ~ // Author: Nathan David Potter  <ndp@opendap_.org>
  ~ //
...
-->
        ...
        <tr>
            <td align="right">
                <div class="medium_bold">
                    <a href="http://www.opendap_.org/online_help_files/opendap_form_help.html#disposition" target="help">
                        Actions
                    </a>
                </div>
            </td>
    ...
    <xsl:template name="dataUrlRow">
        ...
        <tr>
            <td align="right">
                <div class="medium_bold">
                    <a href="http://www.opendap_.org/online_help_files/opendap_form_help.html#data_url" target="help">
                        Data URL
                    </a>
                </div>
            </td>
    ...
    <xsl:template name="globalAttributesRow">
        <tr>
            <td align="right" style="vertical-align:text-top">
                <div class="medium_bold">
                    <a href="http://www.opendap_.org/online_help_files/opendap_form_help.html#global_attr" target="help">
                        Global Attributes
                    </a>
                </div>
            </td>
    ...
    <xsl:template name="VariablesRow">
        <tr>
            <td align="right" style="vertical-align:text-top">
                <div class="medium_bold">
                    <a href="http://www.opendap_.org/online_help_files/opendap_form_help.html#dataset_variables"
    ...
    <xsl:template name="DimensionsRow">
        <tr>
            <td align="right" style="vertical-align:text-top">
                <div class="medium_bold">
                    <a href="http://www.opendap_.org/online_help_files/opendap_form_help.html#shared_dimesions"

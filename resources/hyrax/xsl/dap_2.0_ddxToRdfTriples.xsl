...
<!DOCTYPE xsl:stylesheet [
        ...
        <!ENTITY DAP  "http://iridl.ldeo.columbia.edu/ontologies/opendap_.owl#" >
        <!ENTITY DAP2 "http://xml.opendap_.org/ns/DAP2" >
        ]>
    ...
    <xsl:template match="/dap2:Dataset">
        <rdf:RDF  xml:base="&BASE;" >
            <owl:Ontology
                    rdf:about="&BASE;">
                <owl:imports
                        rdf:resource="http://iridl.ldeo.columbia.edu/ontologies/opendap_.owl"/>
                <owl:imports

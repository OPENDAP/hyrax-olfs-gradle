...
<!DOCTYPE xsl:stylesheet [
        <!ENTITY DAPOBJ  "http://xml.opendap_.org/ontologies/opendap-dap-3.2.owl#" >
        <!ENTITY DAP     "http://xml.opendap_.org/ns/DAP/3.2#" >
    ...
    <xsl:template match="/dap:Dataset">
        ...
        <rdf:RDF>
            ...
            <owl:Ontology rdf:about="{$LocalOntology}">
                <owl:imports rdf:resource="http://xml.opendap_.org/ontologies/opendap-dap-3.2.owl"/>
                <owl:imports
                    rdf:resource="http://xml.opendap_.org/ontologies/NetcdfConventionRegistry.owl"
                />
            </owl:Ontology>

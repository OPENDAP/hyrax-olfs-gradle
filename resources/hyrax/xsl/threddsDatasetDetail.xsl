...
- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
                    ...
                    <td align="left">
                        <span class="small_bold"
                            ...
                            <xsl:choose>
                                ...
                                -->
                                <xsl:when test="matches(./@serviceType, 'opendap_', 'i')">
                            ...
                            <!-- #####################################################
                              ...
                              - Example:
                              -
                              -    "http://test.opendap.org:8080" + "/opendap_/" + "data/nc/fnoc1.nc"
                              -
    ...
    <xsl:template name="DoBrokerLinks">
        ...
        <xsl:variable name="dap2" select="$services/descendant-or-self::thredds:service[lower-case(@serviceType)='opendap_']" />
